...
function HeroSection() {
  return (
    ...
    >
      ...
      <h1 className="text-white text-4xl sm:text-6xl lg:text-7xl font-bold whitespace-nowrap tracking-wide font-georgia">
        Dive into Perfection - Discover the Beauty of Koi
      </h1>
      <h2 className="text-white text-3xl sm:text-3xl lg:text-4xl mt-5 whitespace-nowrap font-georgia">
